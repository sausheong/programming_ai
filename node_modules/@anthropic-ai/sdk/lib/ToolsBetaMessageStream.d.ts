...
import { ToolsBetaContentBlock, Messages, ToolsBetaMessage, ToolsBetaMessageStreamEvent, ToolsBetaMessageParam, MessageCreateParams, MessageCreateParamsBase } from '@anthropic-ai/sdk/resources/beta/tools/messages';
...
export declare class ToolsBetaMessageStream implements AsyncIterable<ToolsBetaMessageStreamEvent> {
    #private;
    ...
    static createMessage(messages: Messages, params: MessageCreateParamsBase, options?: Core.RequestOptions): ToolsBetaMessageStream;
    protected _run(executor: () => Promise<any>): void;
    protected _addMessageParam(message: ToolsBetaMessageParam): void;
    protected _addMessage(message: ToolsBetaMessage, emit?: boolean): void;
     ...
     */
    finalMessage(): Promise<ToolsBetaMessage>;
    /**
...
//# sourceMappingURL=ToolsBetaMessageStream.d.ts.map